...
public class IndexOntologyService{
    ...
    private static final Logger logger = LoggerFactory.getLogger("IndexOntologyService");

    //@ TODO:  handle IOException
    public OWLOntology validateAndCreateOWLOntology(StreamRec streamRec) throws IOException, OWLOntologyCreationException {
        ...
        logger.info("Validating %s  ontology file.",streamRec.getFileName());
        ...
        HashMap<String, OWLAnnotationProperty> annotationProperties = getAnnotationPropertyHashMap(ontology);
    ...
    public void indexOntology(StreamRec streamRec, OWLOntology ontology) throws IOException {
       ...
       */
        ...
        try{
            ...
            logger.error("Exception thrown while indexing the owl file.",e);
            throw  new BadRequestException("Problem occurred while indexing the OWL file.");
        }
    }

    private HashMap<String, OWLAnnotationProperty> getAnnotationPropertyHashMap(OWLOntology ontology) {
